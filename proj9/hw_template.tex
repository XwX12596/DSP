...
\begin{figure}[!h]
	\centering
	\subfigure[pre-quantization]{\includegraphics[height=1.5 in]{code/img.jpg}}
	\hspace{0 pt}
	\subfigure[M = 2]{\includegraphics[height=1.5 in]{code/new2.jpg}}
	\hspace{0 pt}
	\subfigure[M = 3]{\includegraphics[height=1.5 in]{code/new3.jpg}}
	\hspace{0 pt}
	\subfigure[M = 4]{\includegraphics[height=1.5 in]{code/new4.jpg}}
	\hspace{0 pt}
	\subfigure[M = 5]{\includegraphics[height=1.5 in]{code/new5.jpg}}
	\hspace{0 pt}
	\subfigure[M = 6]{\includegraphics[height=1.5 in]{code/new6.jpg}}
	\hspace{0 pt}
	\subfigure[M = 7]{\includegraphics[height=1.5 in]{code/new7.jpg}}
	\hspace{0 pt}
	\subfigure[M = 8]{\includegraphics[height=1.5 in]{code/new8.jpg}}
	\hspace{0 pt}
	\subfigure[M = 9]{\includegraphics[height=1.5 in]{code/new9.jpg}}
	% \hspace{0 pt}
